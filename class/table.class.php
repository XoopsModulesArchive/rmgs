<?php
/*******************************************************************
* $Id: table.class.php 2 2006-12-11 20:49:07Z BitC3R0 $      *
* -----------------------------------------------------------      *
* RMSOFT Shopper 1.0                                               *
* Sistema de Comercio en Lnea                                     *
...
* -----------------------------------------------------------      *
* table.class.php:                                                 *
* Clase para imprimir tablas y sus componentes                     *
* -----------------------------------------------------------      *
* @copyright:  2005 - 2006. BitC3R0.                              *
* @autor: BitC3R0                                                  *
* @paquete: RMSOFT Shopper v1.0                                    *
* @version: 0.1.1                                                  *
* @modificado: 02/01/2006 11:31:24 a.m.                            *
*******************************************************************/

include_once XOOPS_ROOT_PATH.'/modules/rmgs/class/gsobject.class.php';

class GSTable extends GSObject
{
	var $_rows = array();
	var $_current = array();
	var $_display = false;
	
	function GSTable($display = false){
