<?php
/*******************************************************************
* $Id: rmgs_bk_recents.php 2 2006-12-11 20:49:07Z BitC3R0 $  *
* ---------------------------------------------------------------  *
...
* ---------------------------------------------------------------  *
* rmgs_bk_recents.php:                                             *
* Bloque que muestra las imgenes recientes y permite              *
* hacerlo con imgenes o con ttulos                               *
* ---------------------------------------------------------------  *
* @copyright:  2005 - 2006. BitC3R0.                              *
* @autor: BitC3R0                                                  *
* @paquete: RMSOFT GS v2.0                                         *
* @version: 0.2.7                                                  *
* @modificado: 01/03/2006 09:17:09 p.m.                            *
*******************************************************************/

include_once XOOPS_ROOT_PATH.'/modules/rmgs/include/block.func.php';

function rmgs_bk_recents($options){
	global $xoopsTpl;
	...
	$result = $db->query("SELECT * FROM ".$db->prefix("rmgs_imgs")." ORDER BY `update` DESC LIMIT 0, $options[0]");
	$block = array();
	$i=1;
...
function rmgs_bk_recents_edit($options){
