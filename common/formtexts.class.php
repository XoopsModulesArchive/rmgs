<?php
/*******************************************************************
* $Id: formtexts.class.php 2 2006-12-11 20:49:07Z BitC3R0 $  *
* ---------------------------------------------------------------  *
...
* ---------------------------------------------------------------  *
* formtexts.class.php:                                             *
* Clases para creacion de elementos de texto para formularios      *
* ---------------------------------------------------------------  *
* @copyright: © 2005 - 2006. BitC3R0.                              *
* @autor: BitC3R0                                                  *
* @paquete: RMSOFT GS 2.0                                          *
* @version: 0.1.0                                                  *
* @modificado: 17/12/2005 08:37:16 p.m.                            *
*******************************************************************/
